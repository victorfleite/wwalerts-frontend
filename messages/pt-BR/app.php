...
return [ 
		...
		'emergencia.index.title_mapa'=>'Mapa de Avisos',
		'emergencia.index.total_avisos'=>'Total de Avisos',
		...
		'emergencia.message.error.jurisdicao_nao_permitida' => 'Você não tem permissão para criar evento nesta jurisdição',
		'emergencia.jurisdicao.sem_jurisdicao'=>'<strong>Você não possui jurisdicão!</strong> Entre em contato com o Administrador do Sistema para lhe atribuir um ou mais jurisdições.',
