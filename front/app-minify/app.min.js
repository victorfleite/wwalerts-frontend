...
app.service("codarService",["$http","$log","$translate","utilService",function($http,$log,$translate,utilService){this.getCodares=function(){return $http.get("data/codar.json")},this.codarI18nFilter=function(input,field){var language=$translate.use();return eval('input["'+language+'"].'+field)}}]);
// Source: app-minify/services/emergencia.js
app.service("emergenciaService",["$http","$log","$translate","utilService",function(a,b,c,d){this.getEmergenciasHoje=function(){return a.get("data/today.json")},this.getEmergenciasAmanha=function(){return a.get("data/tomorrow.json")},this.getEmergenciasFuturas=function(){return a.get("data/future.json")},this.getEmergencia=function(b){return a.get("/index.php?r=frontend/front/emergencia&id="+b)},this.emergenciaI18nFilter=function(a,b){var d=c.use();return a[d][b]}}]);
// Source: app-minify/services/pais.js
app.service("paisService",["$http","$log","utilService",function(a,b,c){this.getMapCenterConfig=function(){return a.get("data/map-config.json")},this.getMapWmsConfig=function(){return a.get("data/wms.json")}}]);
// Source: app-minify/services/pop-up.js
app.service("popUpService",["$log","ModalService",function(a,b){var c={};this.isEmpty=function(a){return angular.equals({},a)?!0:!1},this.showSingletonModal=function(a,d,e){this.isEmpty(c)&&(b.showModal({templateUrl:a.templateUrl,controller:a.controller,inputs:a.inputs}).then(function(a){a.close.then(function(a){c={}}),d(a)})["catch"](function(a){e(a)}),c={modalId:Math.floor(1e5*Math.random()+1)})}}]);
